	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<p>The &quot;Register CDU&quot; function allows the registering of new a CDU for a selected court site from the provided list.</p>

				<p>The &quot;CDU Number&quot; field is the hostname of the CDU and must be in the form of CDU0001. This is shown on all the display pages, as part of the debug line, allowing us to identify CDUs by number easily.</p> 
				...
				<p>The &quot;Notification&quot; field is a message you wish to display on the CDU screen (e.g. Welcome to Snaresbrook Crown Court). This is shown in a marquee along the bottom of the CDU screen. The field is pre-populated with the notification value defined for the Local Proxy the  CDU is being registered against. </p> 
